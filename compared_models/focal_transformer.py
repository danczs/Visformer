...
def focal_t():
    return FocalTransformer(img_size=224, embed_dim=96, depths=[2, 2, 6, 2], drop_path_rate=0.2,
...
def focal_s():
    return FocalTransformer(img_size=224, embed_dim=96, depths=[2, 2, 18, 2], drop_path_rate=0.2,
         focal_levels=[2, 2, 2, 2], expand_sizes=[3, 3, 3, 3], expand_layer="all",
         num_heads=[3, 6, 12, 24],
         focal_windows=[7, 5, 3, 1],
         window_size=7,
